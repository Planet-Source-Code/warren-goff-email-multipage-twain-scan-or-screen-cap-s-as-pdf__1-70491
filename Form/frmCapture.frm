...
Private Sub CaptureIt(xStart As Single, xEnd As Single, yStart As Single, yEnd As Single)
  Dim Left As Long, Top As Long, Right As Long, Bottom As Long
  Dim lWidth As Long, lHeight As Long, MMM As String, intSave As Integer
On Error Resume Next
 ...
 'Close #11
  ...
  SavePicture picTemp.Image, App.Path & "\" & Format(Now, "ddmmyyhhmmss") & ".bmp"


    intSave = MsgBox("Do you want to Capture Another One?", _
                     vbYesNoCancel + vbExclamation)
    Select Case intSave
        Case vbYes
            Unload Me
            AnotherOne = True
            MEmail.mnuCaptureUrl_Click
        Case vbNo
            MEmail.Visible = True
            AnotherOne = False
            Unload Me
...
Set frmCapture = Nothing
MEmail.Visible = True
If AnotherOne = False Then MEmail.Command2_Click
End Sub
